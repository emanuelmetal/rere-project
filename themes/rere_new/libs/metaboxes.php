...
function estate_sidebar_meta() {
    ...
    add_meta_box('wpestate-header',             __('Header Options','wpestate'), 'estate_header_function', 'page', 'normal', 'low');
    add_meta_box('wpestate-header',             __('Header Options','wpestate'), 'estate_header_function', 'post', 'normal', 'low');
    add_meta_box('wpestate-header',             __('Header Options','wpestate'), 'estate_header_function', 'estate_agent', 'normal', 'low');
    add_meta_box('wpestate-header',             __('Header Options','wpestate'), 'estate_header_function', 'estate_property', 'normal', 'low');
