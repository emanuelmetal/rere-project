                ...
                foreach($adv_search_what as $key=>$search_field){
                    ...
                    if($search_field=='none'){
                        $return_string.=''; 
                            ...
                            $return_string.='
                            <div class="dropdown  listing_filter_select form-control">
                                <div data-toggle="dropdown" id="contystate_mobile_shortcode" class="filter_menu_trigger" data-value="all">'
                                    .__('All Counties/States','wpestate').'<span class="caret caret_filter"></span>
                                </div>           
                                <input type="hidden" name="advanced_contystate" value="">
                                <ul id="adv-search-countystate" class="dropdown-menu filter_menu" role="menu" aria-labelledby="contystate_mobile_shortcode">
                            ...
                            if ( $adv_search_what[$key]=='property price'){
                                ...
                                if ($show_slider_price == 'yes'){
                                        ...
                                        <div class="adv_search_sh">
                                            <p>
                                                <label for="amount_sh">'.__('Price range:','wpestate').'</label>
                                                <span id="amount_sh"  style="border:0; font-weight:bold;">'.$price_slider_label.'</span>
                                            </p>
                    ...
                    if ($show_slider_price =='yes'){
                        ...
                        $return_string.='
                            <div class="adv_search_sh">
                                <p>
                                    <label for="amount_sh">'.__('Price range:','wpestate').'</label>
                                    <span id="amount_sh"  style="border:0; color:#f6931f; font-weight:bold;">'.$price_slider_label.'</span>
                                </p>
                                <div id="slider_price_sh"></div>
                                <input type="hidden" id="price_low_sh"  name="price_low"  value="'.$min_price_slider.'" />
                                <input type="hidden" id="price_max_sh"  name="price_max"  value="'.$max_price_slider.'" />
