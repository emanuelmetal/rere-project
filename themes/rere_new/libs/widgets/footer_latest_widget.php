          ...
          //   print_r($args);
              ...
              //  add_filter( 'posts_orderby', 'wpestate_my_order' );
                ...
                while ( $the_query->have_posts() ) :
                        ...
                        $display.='<div class="listing_name '.$class.' ">
                                        <span class=widget_latest_title><a href="'.$link.'">'.get_the_title().'</a></span>
                                        <span class=widget_latest_price>'. $price.' '.$price_label.'</span>
                                   </div>' ;
                        $display.='</div>';
                endwhile;
